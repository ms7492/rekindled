    ...
    <div className="relative w-full">
      ...
      <div className="flex items-end gap-3">
        <textarea
          ...
          rows={1}
          className="flex-1 resize-none rounded-2xl border border-border bg-secondary/50 text-foreground placeholder:text-muted-foreground px-5 py-3 text-base focus:outline-none focus:ring-2 focus:ring-accent/30 min-h-[48px] max-h-[120px]"
          style={{ height: "48px" }}
          onInput={(e) => {
